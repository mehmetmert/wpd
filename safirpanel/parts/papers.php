	...
	<div class="formitem">
		<div class="items">
			...
			<ul>
				<?php 
				global $safirPapers;
				foreach ($safirPapers as $k => $v) : ?>
					<li>
						<label class="selectit">
							<input value="<?php echo $k ?>" type="checkbox" name="<?php echo SAFIR_THEME_SLUG . '_' . $key ?>[]" <?php if (is_array(xoption($key)) && in_array($k, xoption($key))) echo "checked" ?>><?php echo $v->name ?>
						</label>
					</li>
				<?php endforeach; ?>
			</ul>
